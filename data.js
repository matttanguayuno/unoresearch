          ...
          "features": [
            {
              ...
              "cells": {
                "dreamflow": { "status": "NO", "note": "Uses a fixed AI model. No user-facing model selection documented.", "links": ["https://docs.dreamflow.com/workspace/agent-panel"] },
                "lovable": { "status": "YES", "note": "Model selection available: Claude, GPT-4o, and Gemini. Users can switch between models during a session.", "links": ["https://docs.lovable.dev/introduction/getting-started"] },
                "vibecode": { "status": "NO", "note": "Tied to Claude Code as the underlying AI engine. No model choice.", "links": ["https://vibecodeapp.mintlify.app/docs"] },
                "builder": { "status": "LIMITED", "note": "Uses its own model routing. Enterprise plans may offer model configuration. Not documented as user-facing choice.", "links": ["https://www.builder.io/fusion"] },
                "bolt": { "status": "YES", "note": "Model switching available. Users can select between different AI models for code generation.", "links": ["https://support.bolt.new/building/intro-bolt"] },
                "tempo": { "status": "YES", "note": "Direct model selection with 7 options: Auto (default), Opus 4.6, Sonnet 4.6, Haiku 4.5, Gemini 3.1 Pro, GPT 5.2, and GPT 5.3 Codex. Auto is available on all plans; other models appear locked behind paid tiers. Also offers three chat modes: Normal, Reasoning (multi-model), and Search (with sourced answers).", "links": ["https://www.tempo.new"], "evidence": [{"type": "screenshot", "sourceCategory": "official", "url": "", "title": "Tempo Labs — Model Selection UI", "snippet": "Model picker shows Auto (selected), Opus 4.6, Sonnet 4.6, Haiku 4.5, Gemini 3.1 Pro, GPT 5.2, GPT 5.3 Codex. Non-Auto models show lock icons indicating paid tier access."}], "screenshots": ["tempo-llm-mode-selection.png"] }
              }
            },
            {
