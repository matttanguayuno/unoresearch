...
| **Mode selection** | 5/6 (5 YES) | Dreamflow, Lovable, Builder, Bolt, and Tempo offer distinct modes (chat, edit, reasoning, search). Vibecode uses a single mode. Offer plan/code/chat/review modes with auto-switching. |
