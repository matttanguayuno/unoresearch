...
const AGENT_UX_FEATURES = [
  ...
  { id: 'multi-mode',      name: 'Mode Selection',     icon: '🔀' },
  ...
  { id: 'speech-to-prompt',    name: 'Speech to Prompt',     icon: '🗣️' },
];
...
const AGENT_UX_MATRIX = {
  ...
  'Bolt': {
    ...
    'speech-to-prompt':    { status: 'NO', screenshots: [] },
  },
  ...
  'Claude': {
    ...
    'llm-model-selection': { status: 'YES', screenshots: [], note: 'Model picker with 6 options + extended thinking toggle:<ul><li>Opus 4.6</li><li>Sonnet 4.6 (default)</li><li>Haiku 4.5</li></ul>More models:<ul><li>Opus 4.5</li><li>Opus 3</li><li>Sonnet 4.5</li></ul>Extended thinking available for longer complex tasks.' },
  ...
  'Cursor': {
    ...
    'llm-model-selection': { status: 'YES', screenshots: ['screenshots/cursor-llm-model-selection.png'], note: 'Extensive model picker + bring-your-own-model (BYOM) support:<ul><li>Auto</li><li>MAX Mode</li><li>Composer 1.5</li><li>GPT-5.4</li><li>GPT-5.3 Codex</li><li>Sonnet 4.6</li><li>Opus 4.6</li></ul>Also supports Add Models for custom API keys and additional providers.' },
    'starting-prompt':     { status: 'YES', screenshots: [] },
    'speech-to-prompt':    { status: 'NO', screenshots: [] },
  },
  ...
  'Lovable': {
    ...
    'speech-to-prompt':    { status: 'YES', screenshots: ['screenshots/lovable-starting-prompt-4.png'] },
  },
  ...
  'Vercel': {
    ...
    'multi-mode':      { status: 'YES',  screenshots: ['screenshots/vercel-mode-selection.png'] },
    'speech-to-text':  { status: 'NO',  screenshots: [] },
    'token-management':{ status: 'NO',  screenshots: [] },
  ...
  'VS Code': {
    ...
    'llm-model-selection': { status: 'YES', screenshots: ['screenshots/vscode-llm-model-selection-1.png', 'screenshots/vscode-llm-model-selection-2.png'], note: 'Broadest model selection with 21 models plus Auto and BYOM support:<ul><li><b>Default:</b> Claude Opus 4.6, Sonnet 4.6, GPT-5.3-Codex, GPT-5.4</li><li><b>Other Models:</b> Claude Haiku 4.5, Opus 4.5, Sonnet 4, Sonnet 4.5, Gemini 2.5 Pro, Gemini 3 Flash (Preview), Gemini 3 Pro (Preview), GPT-4.1, GPT-4o, GPT-5 mini, GPT-5.1, GPT-5.1-Codex, GPT-5.1-Codex-Max, GPT-5.1-Codex-Mini (Preview), GPT-5.2-Codex, Grok Code Fast 1</li></ul>Also supports bring-your-own-model via custom API keys.' },
