  ...
  categories: [
    ...
    },
    {
      ...
      features: [
        ...
        { id: "speech-to-prompt", name: "Speech to prompt", priority: "p2", coverage: "2/6", coverageDetail: "2 YES (Vibecode, Lovable)", note: "Voice input for prompts enables hands-free interaction and faster prompt entry. Differentiator for accessibility." }
      ]
    }
  ]
};
